...
- 「〇〇練習」のような汎用表現は禁止。必ず具体的な演習内容を書くこと
- 例: reading →「長文1題＋語彙問題10問」「4択問題2セット精読」
- 例: listening →「会話問題3問→スクリプト確認」「短文応答6問解く」
- 例: writing →「英作文1問→自己添削」「25語メール文を書く」「模範答案と比較」
- 例: speaking →「2分スピーチ1本録音→聴き直し」「質疑応答の即答練習」
- 例: flashcards →「due カード全件→難しいもの3回繰り返し」
- 30字以内で書くこと
