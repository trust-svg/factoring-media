...
JP_CANDIDATES = ["7203.T", "6758.T", "6367.T", "8306.T", "9984.T", "7974.T", "6857.T", "4063.T"]
US_CANDIDATES = ["AAPL", "NVDA", "MSFT", "GOOGL", "AMZN", "TSLA", "META", "AMD"]
...
def run_trading_cycle(market: str) -> dict:
    ...
    prices_text = "\n".join(
        f"- {t}: ${p:.2f}" for t, p in prices.items() if t in candidates
    )
